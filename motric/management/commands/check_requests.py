...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
    	...
    	table_w = '<table cellpadding="3" border="1" style="border:2px solid gray; border-collapse:collapse"><caption style="color:orange; font-size:14px; font-weight:bold; text-align:left; margin-bottom:5px">Requests that not fulfilled for more than' + str(days_warn) + ' days (amount: ' + str(warn_set.count()) + ')</caption>'
    	for e in warn_set:
